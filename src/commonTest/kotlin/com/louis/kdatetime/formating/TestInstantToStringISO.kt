...
class TestInstantToStringISO {
    ...
    @Test
    fun test_format_with_basic_iso_date() {
        val utc = formatISO(fakeInstant, UTC, ISO.BASIC_ISO_DATE)
        val paris = formatISO(fakeInstant, PARIS, ISO.BASIC_ISO_DATE)
        val london = formatISO(fakeInstant, LONDON, ISO.BASIC_ISO_DATE)
        assertEquals( "20211215Z", utc)
        assertEquals( "20211215+0100", paris)
        assertEquals( "20211215Z", london)
    }

    @Test
    fun test_format_with_iso_date() {
    ...
    @Test
    fun test_format_with_iso_date_time() {
    ...
    @Test
    fun test_format_with_iso_instant() {
    ...
    @Test
    fun test_format_with_iso_local_date() {
    ...
    @Test
    fun test_format_with_iso_local_date_time() {
    ...
    @Test
    fun test_format_with_iso_local_time() {
    ...
    @Test
    fun test_format_with_iso_offset_date() {
    ...
    @Test
    fun test_format_with_iso_offset_date_time() {
    ...
    @Test
    fun test_format_with_iso_offset_time() {
    ...
    @Test
    fun test_format_with_iso_ordinal_date() {
    ...
    @Test
    fun test_format_with_iso_week_date() {
    ...
    @Test
    fun test_format_with_iso_zoned_date_time() {
    ...
    @Test
    fun test_format_with_rfc_1123_date_time() {
